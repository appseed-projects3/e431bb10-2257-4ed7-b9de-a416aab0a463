...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-18 21:44`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e431bb10-2257-4ed7-b9de-a416aab0a463.git
$ cd e431bb10-2257-4ed7-b9de-a416aab0a463
```
